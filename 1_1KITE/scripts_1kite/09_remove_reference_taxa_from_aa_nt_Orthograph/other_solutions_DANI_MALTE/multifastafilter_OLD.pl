...
if ($help) {
	print "Usage: $0 LISTFILE FASTAFILE FASTAFILE FASTAFILE [...]\n\n";
	print "The LISTFILE must contain a newline-separated list of sequence identifiers.\n";
	print "This program removes the respective sequences from the FASTAFILEs,\n";
	print "optionally writing them to a tracefile (-t option). \n";
	print "Obtain more information using `perldoc $0`.\n";
	exit;
}
